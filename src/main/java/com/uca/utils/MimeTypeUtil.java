...
public class MimeTypeUtil {
	 ...
	 * 图片
	 */
	public static final SourceType pic = new SourceType("1", "图片", "uca/pic");
	
	/**
	 * 音频
	 */
	public static final SourceType audio = new SourceType("2", "音频", "uca/audio");
	
	/**
	 * 视频
	 */
	public static final SourceType video = new SourceType("3", "视频", "uca/video");
	
	/**
	 * 文档
	 */
	public static final SourceType doc = new SourceType("4", "文档", "uca/doc");
	
	/**
	 * 可执行程序
	 */
	public static final SourceType exe = new SourceType("5", "可执行程序", "uca/exe");
